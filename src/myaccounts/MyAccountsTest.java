...
public class MyAccountsTest extends Utility {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() {
        ...
        sendTextOnElement(By.xpath("//input[@id='input-firstname']"), "Pinal");

        //Enter the Last Name
        sendTextOnElement(By.xpath("//input[@id='input-lastname']"), "Kamani");

        //Enter the Email
        sendTextOnElement(By.xpath("//input[@id='input-email']"), "Pinal125@gmail.com");
        //Enter the Telephone
        sendTextOnElement(By.xpath("//input[@id='input-telephone']"), "125463987");
        //3.7 Enter the Password
        sendTextOnElement(By.xpath("//input[@id='input-password']"), "Pinal5263");

        //3.8 Enter the Password Confirm
        sendTextOnElement(By.xpath("//input[@id='input-confirm']"), "Pinal5263");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() {
        ...
        sendTextOnElement(By.xpath("//input[@id='input-email']"), "Pinal12@gmail.com");

        //4.4 Enter the Last Name
        //sendTextOnElement(By.xpath(""),"Kamani");

        //4.5 Enter the Password
        sendTextOnElement(By.xpath("//input[@id='input-password']"), "Pinal120");
