...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextOnElement(By.xpath("//input[@id='input-payment-firstname']"),"Pinal");
        sendTextOnElement(By.xpath("//input[@id='input-payment-lastname']"),"Kamani");
        sendTextOnElement(By.xpath("//input[@id='input-payment-email']"),"Pinal123@gmail.com");
        sendTextOnElement(By.xpath("//input[@id='input-payment-telephone']"),"2528965321");
        sendTextOnElement(By.xpath("//input[@id='input-payment-address-1']"),"2396, Derbyy");
        sendTextOnElement(By.xpath("//input[@id='input-payment-city']"),"Derby");
        sendTextOnElement(By.xpath("//input[@id='input-payment-postcode']"),"D25 632");
        ...
        //String actualWaringMessage=getTextFromElement(By.xpath(""))
